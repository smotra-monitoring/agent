...
mod tests {
    ...
    fn test_display_claim_info_does_not_panic() {
        ...
        let claim_url = "https://smotra.example.com/claim";
        let expires_at = Utc::now() + Duration::hours(24);

        // Should not panic
        display_claim_info(agent_id, claim_token, claim_url, expires_at);
    }
}
